...
public class WxPaymentResponse extends BaseResponse{
	
	private static final long serialVersionUID = -5840111079515257132L;
	/**
	 * 返回状态码
	 */
	...
	public String toString() {
		return "WxPaymentResponse [return_code=" + return_code
